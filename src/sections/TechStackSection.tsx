      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-0 pointer-events-none select-none" style={{width: 480, height: 480, background: 'transparent'}}>
        ...
        <div
          style={{
            ...
            boxShadow: '0 0 80px 28px rgba(6,182,212,0.25), 0 0 120px 40px rgba(168,85,247,0.18)',
        ...
        <div
          style={{
            ...
            transform: 'translate(-50%,-50%)',
            borderRadius: '50%',
            background: 'radial-gradient(circle at 60% 40%, rgba(34,211,238,0.2) 0%, transparent 75%)',
            filter: 'blur(14px)',
            opacity: 0.35,
