  ...
  return (
    ...
    >
      <motion.div
        ...
        className="z-30 w-full flex justify-center mb-2"
        style={{ pointerEvents: "none" }}
      >
        <h2
          className="text-5xl sm:text-6xl font-black tracking-tight mb-0 bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 text-transparent bg-clip-text drop-shadow-2xl shadow-cyan-500/30"
          style={{ letterSpacing: "0.04em", textShadow: "0 4px 32px #000, 0 2px 0 #222" }}
        >
      ...
      <motion.div
        ...
        className="relative w-full max-w-3xl min-h-[420px] flex flex-col items-center justify-center mt-8"
