    ...
    <section id="hero" className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-stretch gap-8 mt-24 relative z-10 w-full max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.07, boxShadow: "0 8px 32px 0 rgba(34,211,238,0.25)" }}
          className="relative w-[320px] h-[320px] flex items-end justify-center select-none bg-black/80 rounded-2xl border-4 border-white/20 shadow-xl md:mr-10 transition-all duration-300"
        >
          <Image
            src="/AK.png"
            alt="Profile"
            width={320}
            height={320}
            className="object-contain w-full h-full rounded-2xl transition-all duration-300 bg-black"
            priority
          />
          <div className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-white/80 via-white/10 to-transparent pointer-events-none rounded-b-2xl" style={{filter:'blur(8px)'}} />
        </motion.div>
