...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black">
      {/* Animated top-right highlight box */}
      <div className="fixed md:absolute top-6 right-4 md:right-12 z-50">
        <a href="https://www.example.com" target="_blank" rel="noopener noreferrer">
          <motion.div
            initial={{ scale: 0.8, opacity: 0.7 }}
            animate={{ scale: [1, 1.15, 1], opacity: [0.7, 1, 0.7] }}
            transition={{ duration: 1.2, repeat: Infinity, repeatType: "reverse", ease: "easeInOut" }}
            className="px-3 py-1 rounded-lg bg-gradient-to-r from-purple-200 via-cyan-100 to-blue-100 shadow-xl border border-white/40 text-red-400 font-extrabold text-xs sm:text-sm tracking-widest"
            style={{ fontFamily: 'Poppins, sans-serif', boxShadow: "0 2px 12px 0 rgba(128,90,213,0.18)" }}
          >
            OUR NEW BRAND
          </motion.div>
        </a>
