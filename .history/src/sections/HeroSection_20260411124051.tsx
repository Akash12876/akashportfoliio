    ...
    <section id="hero" className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="fixed md:absolute top-6 right-4 md:right-12 z-50">
        <motion.div
          ...
          className="px-6 py-2 rounded-xl bg-gradient-to-r from-purple-500 via-cyan-400 to-blue-500 shadow-2xl border-2 border-white/60 text-white font-extrabold text-base sm:text-lg tracking-widest"
          style={{ boxShadow: "0 4px 24px 0 rgba(128,90,213,0.25)" }}
        >
          OUR NEW BRAND
        </motion.div>
      </div>
