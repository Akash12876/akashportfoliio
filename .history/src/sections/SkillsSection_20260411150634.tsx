...
const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: "Shopify", icon: <img src="/shopify.png" alt="Shopify" className="w-7 h-7 object-contain inline-block" />, level: "Intermediate" },
      { name: "WordPress", icon: <img src="/wordpress.png" alt="WordPress" className="w-7 h-7 object-contain inline-block" />, level: "Intermediate" },
    ],
  },
  {
