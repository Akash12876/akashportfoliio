...
export default function TechStackSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full py-20 px-4 sm:px-8 flex flex-col items-center bg-gradient-to-b from-[#0a0a1a] to-[#181824] relative overflow-hidden">
      {/* Animated 3D glassmorphic blurred rotating background */}
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(135deg, rgba(0,255,255,0.18) 0%, rgba(120,0,255,0.13) 100%)',
          borderRadius: '50%',
          boxShadow: '0 0 120px 40px #00eaff44, 0 0 180px 60px #a855f744',
          animation: 'rotate3dGlass 14s linear infinite',
          opacity: 0.7,
          pointerEvents: 'none',
        }}
      />
      <style>{`
        @keyframes rotate3dGlass {
          0% { transform: translate(-50%,-50%) rotateX(0deg) rotateZ(0deg) scale(1); }
          50% { transform: translate(-50%,-50%) rotateX(18deg) rotateZ(180deg) scale(1.08); }
