      ...
      <div className="flex flex-col items-center gap-8 mt-24 relative z-10">
        ...
        <div className="flex gap-6 mt-8 items-center justify-center w-full">
          ...
          >
            ...
            <span className="absolute left-0 bottom-0 w-full h-full bg-black/80 rounded-full scale-y-0 group-hover:scale-y-100 origin-bottom transition-transform duration-300 z-0" />
            <span className="absolute inset-0 rounded-full ring-2 ring-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
          </a>
          <a
            href="#contact"
          ...
          >
            <span className="relative z-10 transition-colors duration-300 group-hover:text-white">Contact Me</span>
            <span className="absolute left-0 bottom-0 w-full h-full bg-black/80 rounded-full scale-y-0 group-hover:scale-y-100 origin-bottom transition-transform duration-300 z-0" />
            <span className="absolute inset-0 rounded-full ring-2 ring-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
          </a>
        </div>
