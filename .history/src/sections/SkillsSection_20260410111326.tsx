...
import { SiTypescript, SiTailwindcss, SiNextdotjs, SiDocker, SiMongodb, SiRedux, SiKubernetes, SiAmazonaws, SiGithubactions, SiJenkins, SiNginx, SiTerraform } from "react-icons/si";
...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      { name: "AWS", icon: <SiAmazonaws className="text-yellow-400" />, level: "Advanced" },
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-3xl min-h-[420px] flex flex-col items-center justify-center mt-24"
