      ...
      <div className="flex flex-wrap justify-center gap-6 mt-8 max-w-5xl relative z-10">
        {techIcons.map((icon, i) => (
          <div
            ...
            style={{ width: 100, height: 100, minWidth: 100, minHeight: 100, padding: 0, perspective: 600 }}
          >
            <div className="relative w-[80px] h-[80px] flex items-center justify-center group/3d">
              <div className="absolute inset-0 w-1/2 h-full left-0 overflow-hidden transition-transform duration-300 group-hover/3d:-translate-x-2 group-hover/3d:-rotate-y-12 origin-left z-10">
                <Image
                  src={icon.src}
                  alt={icon.alt}
                  width={80}
              ...
              <div className="absolute inset-0 w-1/2 h-full right-0 left-auto overflow-hidden transition-transform duration-300 group-hover/3d:translate-x-2 group-hover/3d:rotate-y-12 origin-right z-10">
                <Image
                  src={icon.src}
                  alt={icon.alt}
                  width={80}
        ...
        /* Add to the bottom of the file for custom 3D split effect */
        <style jsx global>{`
          .tech-3d-card .group\/3d:hover .origin-left {
            transform: translateX(-8px) rotateY(-12deg);
          }
          .tech-3d-card .group\/3d:hover .origin-right {
            transform: translateX(8px) rotateY(12deg);
          }
          .tech-3d-card .origin-left, .tech-3d-card .origin-right {
