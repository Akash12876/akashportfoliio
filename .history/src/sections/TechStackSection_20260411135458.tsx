      ...
      <div className="flex flex-wrap justify-center gap-6 mt-8 max-w-5xl relative z-10">
        {techIcons.map((icon, i) => (
          <div
            ...
            className="tech-3d-card bg-white/10 rounded-2xl border border-white/20 shadow-lg flex items-center justify-center backdrop-blur-md transition-all duration-300 hover:z-20"
            style={{ width: 100, height: 100, minWidth: 100, minHeight: 100, padding: 0, perspective: 400 }}
          >
            <div className="relative w-[80px] h-[80px] flex items-center justify-center group/techicon">
              <div className="absolute inset-0 flex">
                <div className="tech-half tech-half-left w-1/2 h-full overflow-hidden transition-transform duration-300 group-hover/techicon:-translate-x-2 group-hover/techicon:-rotate-y-12" style={{zIndex:2}}>
                  <Image
                    src={icon.src}
                    alt={icon.alt}
                    width={40}
                    ...
                    style={{objectPosition:'left'}} draggable={false}
                  />
                </div>
                <div className="tech-half tech-half-right w-1/2 h-full overflow-hidden transition-transform duration-300 group-hover/techicon:translate-x-2 group-hover/techicon:rotate-y-12" style={{zIndex:2}}>
                  <Image
                    src={icon.src}
                    alt={icon.alt}
                    width={40}
                    height={80}
                    className="object-contain w-full h-full"
                    style={{objectPosition:'right'}} draggable={false}
                  />
                </div>
              </div>
            </div>
            <style jsx>{`
              ...
              .group-hover\/techicon\:-translate-x-2:hover .tech-half-left {
                transform: translateX(-12px) rotateY(-12deg);
              }
              .group-hover\/techicon\:translate-x-2:hover .tech-half-right {
                transform: translateX(12px) rotateY(12deg);
              }
            `}</style>
          </div>
