...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="w-full flex justify-center items-center py-16 px-2 bg-transparent relative overflow-hidden">
      <ContactNetBg />
      ...
      >
        ...
        <div className="flex flex-col justify-center items-end min-w-[220px] md:pl-12">
          <div className="mb-8">
      ...
      <div className="w-full flex justify-center" style={{ marginTop: '4.5rem' }}>
        <IparxMediaLogo />
      </div>
    </section>
  );
