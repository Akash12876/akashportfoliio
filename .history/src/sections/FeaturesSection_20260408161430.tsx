      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-5xl">
        {features.map((f, i) => (
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-0 rounded-2xl border-2 border-white/30" style={{backdropFilter:'blur(12px)', WebkitBackdropFilter:'blur(12px)', boxShadow:'0 0 0 2px rgba(255,255,255,0.18)'}} />
          >
