...
import { FaReact, FaNodeJs, FaAws, FaHtml5, FaCss3Alt, FaJs, FaMobileAlt, FaDatabase, FaLinux, FaShopify, FaWordpress } from "react-icons/fa";
import { SiTypescript, SiTailwindcss, SiNextdotjs, SiDocker, SiMongodb, SiRedux, SiKubernetes, SiGithubactions, SiJenkins, SiNginx, SiTerraform, SiFlutter, SiAngular } from "react-icons/si";
...
const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Flutter (Dart)", icon: <SiFlutter className="text-blue-400" />, level: "Intermediate" },
