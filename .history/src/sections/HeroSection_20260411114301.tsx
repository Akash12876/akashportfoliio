    ...
    <section id="hero" className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="flex flex-col items-center gap-8 mt-24 relative z-10">
        ...
        <div className="flex gap-6 mt-8 items-center justify-center w-full">
          <a
            href="#projects"
            className="px-10 py-4 rounded-full bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 bg-[length:200%_200%] animate-btn-gradient text-white text-lg font-semibold shadow-lg transition-all duration-300 hover:bg-black/80 hover:ring-2 hover:ring-white focus:outline-none focus:ring-2 focus:ring-cyan-400"
          >
            View Projects
          </a>
          <a
            href="#contact"
            className="px-10 py-4 rounded-full bg-gradient-to-r from-white via-zinc-200 to-cyan-100 bg-[length:200%_200%] animate-btn-gradient text-black text-lg font-semibold border border-zinc-300 shadow-lg transition-all duration-300 hover:bg-black/80 hover:text-white hover:ring-2 hover:ring-white focus:outline-none focus:ring-2 focus:ring-cyan-400"
          >
            Contact Me
          </a>
        </div>
