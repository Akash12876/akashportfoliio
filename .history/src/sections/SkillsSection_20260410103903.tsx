      ...
      <div className="flex flex-col gap-16 w-full max-w-5xl">
        {skillCategories.map((cat, i) => (
          <motion.div
            ...
            className="flex flex-col md:flex-row items-center justify-between bg-zinc-900/90 rounded-3xl shadow-2xl border border-white/10 p-8 md:p-12"
            style={{ minHeight: 340 }}
          >
            {/* Left: Image or Icon grid */}
