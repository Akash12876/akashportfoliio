...
export default function SkillsSection() {
  ...
  return (
    <section id="skills" ref={sectionRef} className="relative w-full py-32 px-4 sm:px-8 bg-gradient-to-br from-[#0a0a0a] via-[#101014] to-[#050509] text-white flex flex-col items-center min-h-[100vh]">
      <motion.h2
