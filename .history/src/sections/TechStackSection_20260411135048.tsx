      ...
      <div className="flex flex-wrap justify-center gap-6 mt-8 max-w-5xl relative z-10">
        {techIcons.map((icon, i) => (
          <div
            ...
            className="bg-white/10 rounded-2xl border border-white/20 shadow-lg flex items-center justify-center backdrop-blur-md transition-all duration-300 hover:z-20 hover:scale-110 hover:-translate-y-3 hover:shadow-2xl"
