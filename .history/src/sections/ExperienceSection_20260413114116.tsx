...
// Experience section removed as per user request.
...
export default function ExperienceSection() {
  return (
    <motion.section
      id="experience"
      className="relative w-full py-20 px-4 sm:px-8 bg-gradient-to-br from-[#0f2027] via-[#232526] to-[#2c5364] text-white flex flex-col items-center"
