...
export default function TechStackSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full py-20 px-4 sm:px-8 flex flex-col items-center bg-gradient-to-b from-[#0a0a1a] to-[#181824] relative overflow-hidden">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-0 pointer-events-none select-none" style={{width: 480, height: 480}}>
        {/* Main glassy orb */}
        <div
          style={{
            width: 340,
            ...
            borderRadius: '50%',
            background: 'linear-gradient(120deg, rgba(0,255,255,0.22) 0%, rgba(120,0,255,0.18) 100%)',
            boxShadow: '0 0 120px 40px #00eaff55, 0 0 180px 60px #a855f755, 0 0 0 60px #fff1',
            filter: 'blur(18px) saturate(1.7)',
            opacity: 0.85,
            animation: 'rotate3dGlassMain 13s cubic-bezier(.7,0,.3,1) infinite',
            zIndex: 1,
          }}
        />
        {/* Inner highlight */}
        <div
          style={{
            ...
            transform: 'translate(-50%,-50%)',
            borderRadius: '50%',
            background: 'radial-gradient(circle at 60% 40%, #fff8 0%, #fff0 80%)',
            filter: 'blur(12px)',
            opacity: 0.7,
            animation: 'rotate3dGlassHighlight 9s cubic-bezier(.7,0,.3,1) infinite',
            zIndex: 2,
          }}
        />
        {/* Outer glow ring */}
        <div
          style={{
            ...
            transform: 'translate(-50%,-50%)',
            borderRadius: '50%',
            background: 'conic-gradient(from 0deg, #00eaff33 0%, #a855f733 100%)',
            filter: 'blur(32px)',
            opacity: 0.5,
            animation: 'rotate3dGlassRing 21s linear infinite',
            zIndex: 0,
          }}
        />
        <style>{`
