...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="w-full flex flex-col items-center py-10 px-1 sm:py-16 sm:px-2 bg-transparent relative overflow-hidden">
      ...
      {/* Desktop: logo right-aligned as before */}
      <div className="hidden md:flex w-full justify-end mt-8 sm:mt-[4.5rem] pr-8">
        <IparxMediaLogo className="max-w-[220px] w-full h-auto" />
      </div>
    </section>
  );
}
