      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-5xl">
        {features.map((f, i) => (
          <motion.div
            ...
            className="group bg-white/10 backdrop-blur-md rounded-2xl border border-[1.5px] border-white/30 shadow-lg p-8 flex flex-col items-center transition-all duration-300"
            style={{
              borderImage: "linear-gradient(120deg,rgba(255,255,255,0.5),#232536 80%) 1",
            }}
          >
            ...
            <h3 className="text-2xl font-bold text-black mb-2 text-center group-hover:text-cyan-400 transition-colors">
              {f.title}
            </h3>
            <p className="text-black text-base text-center opacity-90">{f.desc}</p>
          </motion.div>
        ))}
      </div>
    </section>
