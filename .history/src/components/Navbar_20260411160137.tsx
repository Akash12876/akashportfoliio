...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-6 left-1/2 z-50 -translate-x-1/2 w-[97vw] max-w-5xl rounded-full bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg flex items-center justify-between px-4 sm:px-8 py-3 transition-all overflow-x-auto">
