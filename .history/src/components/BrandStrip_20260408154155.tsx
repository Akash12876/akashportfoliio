...
export default function BrandStrip() {
  return (
    <div className="relative w-full overflow-x-hidden py-8 bg-black bg-[linear-gradient(to_right,rgba(255,255,255,0.07)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.07)_1px,transparent_1px)] bg-[48px_48px]">
