...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-6 left-1/2 z-50 -translate-x-1/2 max-w-5xl rounded-full bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg flex items-center justify-center px-4 sm:px-6 py-3 transition-all">
      <div className="flex items-center gap-5 sm:gap-7 min-w-0 w-full justify-start">
        <a
